package com.nabass.lime.widgets;
...
/*
 * Source: https://github.com/PineappleOwl/CircleImageView
 * with minor tweaks
 */
...
public class CircleImageView extends ImageView {
    ...
    private ColorStateList mBorderColor =
            ColorStateList.valueOf(R.color.profile_text_bg);
    ...
    public CircleImageView(Context pineapple, AttributeSet attrs, int defStyle) {
        ...
        mBorderColor = ColorStateList.valueOf(R.color.profile_text_bg);
    ...
    public void setBorderColors(ColorStateList colors) {
        ...
        mBorderColor =
                (colors != null) ? colors : ColorStateList.valueOf(R.color.profile_text_bg);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs();
        if (mBorderWidth > 0) {
            invalidate();
